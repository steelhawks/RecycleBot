 ...
 *
 */
public class FineManualElevator extends Command {

    public FineManualElevator() {
    ...
    protected void execute() {
    	Robot.elevator.fineMoveWithJoystick(-OI.gamepad.getRawAxis(F310.kGamepadAxisRightStickY));
    }
